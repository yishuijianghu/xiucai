package goods.house.test.modules.oss.service.impl;

import goods.house.test.modules.oss.dao.SysOssDao;
...
public class SysOssServiceImpl implements SysOssService {
	...
	@Override
	public String selectUrlByOriginalNameLike(String originalName) {
		return sysOssDao.selectUrlByOriginalNameLike(originalName);
	}
